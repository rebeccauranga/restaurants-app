create table users (
    ...
    email varchar(200),
    password varchar(500) -- we don't store passwords, we store "hashes" (like an encrypted version of a PW)
...
create table reviews (
    ...
    score integer, 
    content text, 
    -- a single review belongs to a single review (how you know you need a FK)
